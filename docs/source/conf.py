...
sys.path.insert(0, local_path('../edx/analytics/tasks'))  # start from tasks dir
sys.path.append(local_path('.')) # luigi_sphinx
...
extensions = [
    ...
    'sphinx.ext.napoleon'  # allows consuming Google and numpy style docs
]
...
# documentation.
html_theme_options = {
 "repository_url": "https://github.com/openedx/edx-analytics-pipeline",
...
htmlhelp_basename = 'edXanalyticspipelinedoc'
...
def setup(app):
    # Register luigi_sphinx.append_parameters as a docstring processor
    import luigi_sphinx
    app.connect('autodoc-process-docstring', luigi_sphinx.append_parameters)
