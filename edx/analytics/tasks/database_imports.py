...
class ImportRefundHistoricalRefund(ImportMysqlToHiveTableTask):
    """Ecommerce: History: Imports historical refunds from an ecommerce table to a destination directory."""
...
class ImportRefundHistoricalRefundLine(ImportMysqlToHiveTableTask):
    """Ecommerce: History: Imports historical refunds line items from an ecommerce table to a destination directory."""
...
class ImportCurrentRefundRefundState(ImportMysqlToHiveTableTask):
    """Ecommerce: Current: Imports current refund items from an ecommerce table to a destination directory."""
...
class ImportCurrentRefundRefundLineState(ImportMysqlToHiveTableTask):
    """Ecommerce: Current: Imports current refund line items from an ecommerce table to a destination directory."""
...
class ImportCurrentOrderState(ImportMysqlToHiveTableTask):
    """Ecommerce Current: Imports current orders from an ecommerce table to a destination directory."""
...
class ImportPaymentTransactions(ImportMysqlToHiveTableTask):
    """Ecommerce: Payment: Imports payment transaction information from an ecommerce table to a destination dir."""
...
class ImportPaymentProcessorResponse(ImportMysqlToHiveTableTask):
    """Ecommerce: Payment: Imports payment processor response from an ecommerce table to a destination dir."""
