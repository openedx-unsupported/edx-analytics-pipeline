...
INSERT INTO `catalogue_productattributevalue` VALUES
  ...
  (43,'course-v1:AccTest+Otto+Adyen',NULL,NULL,NULL,NULL,NULL,'','',NULL,1,NULL,24,NULL),
  (44,'course-v1:AccTest+Otto+Adyen',NULL,NULL,NULL,NULL,NULL,'','',NULL,1,NULL,25,NULL);
